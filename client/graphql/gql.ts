...
type Documents = {
    ...
    "\n  query GetCandidates($first: Int, $after: String, $passiveLikes: Boolean, $activeLikes: Boolean) {\n    candidates(first: $first, after: $after, passiveLikes: $passiveLikes, activeLikes: $activeLikes) {\n      edges {\n        cursor\n        node {\n          id\n          name\n          profile {\n            avatarUrl\n            age\n            introduction\n          }\n          likesMe\n        }\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n": typeof types.GetCandidatesDocument,
